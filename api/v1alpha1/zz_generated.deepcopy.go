...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicationDestinationInfo) DeepCopyInto(out *ReplicationDestinationInfo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplicationDestinationInfo.
func (in *ReplicationDestinationInfo) DeepCopy() *ReplicationDestinationInfo {
	if in == nil {
		return nil
	}
	out := new(ReplicationDestinationInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ReplicationDestinationSpec) DeepCopyInto(out *ReplicationDestinationSpec) {
	*out = *in
	in.VolSyncPVCInfo.DeepCopyInto(&out.VolSyncPVCInfo)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VolSyncPVCInfo) DeepCopyInto(out *VolSyncPVCInfo) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VolSyncPVCInfo.
func (in *VolSyncPVCInfo) DeepCopy() *VolSyncPVCInfo {
	if in == nil {
		return nil
	}
	out := new(VolSyncPVCInfo)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VolSyncReplicationGroup) DeepCopyInto(out *VolSyncReplicationGroup) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VolSyncReplicationGroup.
func (in *VolSyncReplicationGroup) DeepCopy() *VolSyncReplicationGroup {
	if in == nil {
		return nil
	}
	out := new(VolSyncReplicationGroup)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *VolSyncReplicationGroup) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VolSyncReplicationGroupList) DeepCopyInto(out *VolSyncReplicationGroupList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]VolSyncReplicationGroup, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VolSyncReplicationGroupList.
func (in *VolSyncReplicationGroupList) DeepCopy() *VolSyncReplicationGroupList {
	if in == nil {
		return nil
	}
	out := new(VolSyncReplicationGroupList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *VolSyncReplicationGroupList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VolSyncReplicationGroupSpec) DeepCopyInto(out *VolSyncReplicationGroupSpec) {
	*out = *in
	in.PVCSelector.DeepCopyInto(&out.PVCSelector)
	in.ReplicationClassSelector.DeepCopyInto(&out.ReplicationClassSelector)
	if in.RDSpec != nil {
		in, out := &in.RDSpec, &out.RDSpec
		*out = make([]ReplicationDestinationSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.RSSpec != nil {
		...
		*out = make([]ReplicationSourceSpec, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VolSyncReplicationGroupSpec.
func (in *VolSyncReplicationGroupSpec) DeepCopy() *VolSyncReplicationGroupSpec {
	if in == nil {
		return nil
	}
	out := new(VolSyncReplicationGroupSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VolSyncReplicationGroupStatus) DeepCopyInto(out *VolSyncReplicationGroupStatus) {
	*out = *in
	if in.VolSyncPVCs != nil {
		in, out := &in.VolSyncPVCs, &out.VolSyncPVCs
		*out = make([]VolSyncPVCInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.RDInfo != nil {
		...
		*out = make([]ReplicationDestinationInfo, len(*in))
		copy(*out, *in)
	}
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VolSyncReplicationGroupStatus.
func (in *VolSyncReplicationGroupStatus) DeepCopy() *VolSyncReplicationGroupStatus {
	if in == nil {
		return nil
	}
	out := new(VolSyncReplicationGroupStatus)
	in.DeepCopyInto(out)
	return out
}
